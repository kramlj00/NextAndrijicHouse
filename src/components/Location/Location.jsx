...
import { PHONE_NUMBER, EMAIL } from '@shared/constants';
    ...
    <div
      ...
      <div className={styles.contactUsContainer}>
        ...
        <div className={styles.contactUsDetails}>
          ...
          <div className={styles.contactUsDetails}>
            <div className={styles.contactUsDetailContainer}>
              <MapPinIcon size={20} />
              <p className={styles.contactUsDetail}>{t.address}</p>
            </div>
            <div className={styles.contactUsDetailContainer}>
              <PhoneIcon size={20} />
              <a
                href={`tel:${PHONE_NUMBER.value}`}
                className={styles.contactUsDetail}>
                {PHONE_NUMBER.label}
              </a>
            </div>
            <div className={styles.contactUsDetailContainer}>
              <MailIcon size={20} />
              <a href={`mailto:${EMAIL}`} className={styles.contactUsDetail}>
                {EMAIL}
              </a>
            </div>
          </div>
