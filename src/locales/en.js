const en = {
  ...
  exteriorHref: 'exterior',
  interiorHref: 'interior',
  ...
  contactDescription: 'We offer private bookings and events. Contact us for more details!',
  ...
  interiorImageGallerySubtitle: 'Discover the stunning interior of Andrijić House. From the fully equipped kitchen to the comfortable bedrooms, experience coastal luxury at its finest.',
  ...
  amenitiesDescriptions: {
    ...
    parking: 'Secure parking spaces for all guests',
    beach: 'Exclusive access to pristine coastline with crystal-clear waters',
    kitchen: 'Fully equipped modern kitchen with premium appliances',
    ...
    bedrooms: 'Two comfortable bedrooms for up to 4 guests',
