const hr = {
  ...
  here: 'ovdje',
  amenitiesHref: 'sadrzaji',
  exteriorHref: 'eksterijer',
  interiorHref: 'interijer',
  testimonialsHref: 'recenzije',
  contactHref: 'kontakt',
  interior: 'Interijer',
  exterior: 'Eksterijer',
  ...
  interiorImageGallerySubtitle:
    'Upoznajte prekrasan interijer Andrijić Housea. Od potpuno opremljene kuhinje do udobnih spavaćih soba, svaki kutak dizajniran je za vaš potpuni komfor i uživanje.',
  interiorImageGallerySectionName: 'Interijer',
  amenitiesTitle: 'Luksuzni Sadržaji i Značajke',
  amenitiesSectionName: 'Sadržaji',
  amenitiesSubtitle:
    'Svaki je detalj pomno osmišljen kako bi vaš boravak nadmašio sva očekivanja. Od privatnog pristupa plaži do vrhunskih sadržaja, doživite obalni luksuz u njegovom najboljem izdanju.',
  amenities: {
    wifi: 'Besplatni WiFi',
    parking: 'Privatni Parking',
    beach: 'Privatna Plaža',
    kitchen: 'Potpuno Opremljena Kuhinja',
    terrace: 'Natkrivena Terasa',
    barbecue: 'Privatni Roštilj',
    canoe: 'Kanu',
    sunbeds: 'Ležaljke',
    umbrella: 'Suncobran',
    shower: 'Vanjski Tuš',
    bedrooms: 'Dvije Spavaće Sobe',
    tv: 'TV',
  ...
  amenitiesDescriptions: {
    wifi: 'Besplatni brzi internet kroz cijelu nekretninu',
    parking: 'Sigurni parking za sve goste',
    beach: 'Ekskluzivni pristup netaknutoj obali s kristalno čistom vodom',
    kitchen: 'Potpuno opremljena moderna kuhinja s vrhunskim uređajima',
    terrace: 'Veliki natkriveni vanjski prostor savršen za jelo i opuštanje',
    barbecue: 'Privatni vanjski roštilj za ukusne obroke s pogledom na more',
    canoe: 'Besplatni kanu za istraživanje prekrasne obale',
    sunbeds: 'Udobne ležaljke za opuštanje uz more',
    umbrella: 'Veliki suncobran koji pruža hladovinu u sunčane dane',
    shower: 'Pogodan vanjski tuš nakon aktivnosti na plaži',
    bedrooms: 'Dvije udobne spavaće sobe za do 4 gosta',
  ...
  reviews: {
    sandi: {
      country: 'Slovenija',
      comment:
        'Kuća je savršena za privatni odmor, izvrsno je, čisto s savršenom malom privatnom plažom! Vlasnici su vrlo ljubavi. Najbolja smještaja koju sam doživio u Hrvatskoj do sada!',
    },
    raneiro: {
      country: 'Hrvatska',
      comment:
        'Odlična lokacija, ljubazan domaćin. Apartman sa izravnim pristupom u more! Preporučujem.',
    },
    willj: {
      country: 'Italija',
      comment:
        'Prekrasna lokacija i izuzetno ljubazni i korisni domaćini. Sigurno ćemo se vratiti. Jedino je puhalo jugo, ali sigurno bi u drugom razdoblju to bio savršeni raj!',
    },
    robert: {
      country: 'Njemačka',
      comment:
        'Mjesto za opuštanje u apsolutno mirnom mjestu! Prekrasan pogled na more! Vrhunski opremljen i čist apartman! Vrlo ljubavi domaćini! Sve što je potrebno za savršen odmor!',
    },
    // markus: {
    //   country: "Austrija",
